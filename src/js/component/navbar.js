  ...
  return (
    <nav className="navbar">
      ...
      <div className="btn-group m-3">
        ...
        {dropdownOpen && (
          <div className="dropdown-menu show" style={{ right: 0, minWidth: "200px" }}>
            {store.favorites.length === 0 ? (
              <span className="dropdown-item"><i className="fa-solid fa-circle-exclamation"style={{ color: "#FF1493"}}> No favorites</i></span>
            ) : (
